			...
			<div class="row">
			  <div class="col-md-12">
				 <div class="header-left">
					 <div class="logo">
						<a href="<?= base_url()?>index.php/home"><img src="<?= base_url()?>assets/images/logo.png" alt=""/></a>
					 </div>
					 <div class="menu">
					 ...
					 <li><a class="active-icon c1" href="#"> </a>
						<ul class="sub-icon1 list">
						  <div class="product_control_buttons">
						  	<a href="#"><img src="<?= base_url()?>assets/images/edit.png" alt=""/></a>
						  		<a href="#"><img src="<?= base_url()?>assets/images/close_edit.png" alt=""/></a>
						  </div>
						   <div class="clear"></div>
						  <li class="list_img"><img src="<?= base_url()?>assets/images/1.jpg" alt=""/></li>
